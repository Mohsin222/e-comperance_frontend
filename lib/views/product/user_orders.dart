...
class _UserOrdersState extends ConsumerState<UserOrders> with WidgetsBindingObserver{
int page=1;
@override
  void initState() {
 ...
 await    ref.watch(orderControllerProvider.notifier).getUserOrders( context: context,userId:  userprov!.sId,pageNo: 1);
  }    
  });
...
if(ref.watch(orderNextPagePaginationValue) == true &&
     ...
     page ++;
            ...
            final userprov =ref.watch(userProvider);
 await    ref.watch(orderControllerProvider.notifier).loadMoreOrders( context: context,userId:  userprov!.sId,pageNo: page);
